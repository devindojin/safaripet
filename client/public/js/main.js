    ...
    (function (e) {
      ...
      (l.prototype.options = {
        ...
        (l.prototype._createSelectEl = function () {
          var e = '',
            t = function (e) {
              ...
              return (
                ...
                e.getAttribute('data-class') && (s += e.getAttribute('data-class')),
                e.getAttribute('data-link') && (l = 'data-link=' + e.getAttribute('data-link')),
                '' !== s && (t = 'class="' + s + '" '),
                '<li ' +
                  t +
                  l +
          ...
          [].slice.call(this.el.children).forEach(function (s) {
            if (!s.disabled) {
              ...
              'option' === l
                ? (e += t(s))
                : 'optgroup' === l &&
                  ((e += '<li class="cs-optgroup"><span>' + s.label + '</span><ul>'),
                  [].slice.call(s.children).forEach(function (s) {
                    e += t(s);
                  }),
                  (e += '</ul></li>'));
            }
          ...
          (this.selEl = document.createElement('div')),
            ...
            (this.selEl.innerHTML =
              '<span class="cs-placeholder">' + this.selectedOpt.textContent + '</span>' + s),
            ...
            this.selEl.addEventListener('keydown', function (t) {
              ...
              switch (s) {
                ...
                case 32:
                  t.preventDefault(),
                    e._isOpen() &&
                      'undefined' != typeof e.preSelCurrent &&
                      -1 !== e.preSelCurrent &&
                      e._changeOption(),
                    e._toggleSelect();
                  break;
        ...
        (l.prototype._navigateOpts = function (e) {
          ...
          var t =
            'undefined' != typeof this.preSelCurrent && -1 !== this.preSelCurrent
              ? this.preSelCurrent
              : this.current;
        ...
        (l.prototype._changeOption = function () {
          'undefined' != typeof this.preSelCurrent &&
          ...
          s && classie.remove(s, 'cs-selected'),
