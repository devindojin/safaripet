...
const CheckboxList = ({ loadFilteredResults }) => {
  ...
  const _loc = _locationChecked.reduce((accumulator, currentValue, index, array) => {
    accumulator.push({
  ...
  const _genderoption = gender.reduce((accumulator, currentValue, index, array) => {
    accumulator.push({
      label: currentValue.name,
      value: currentValue.value,
    });
  ...
  const _breedoptions = breed.reduce((accumulator, currentValue, index, array) => {
    accumulator.push({
      label: currentValue.name,
      value: currentValue.value,
    });
